# 🚀 Awtrix Omni-Logique Framework (v2.0.0)
...
2.  **Sensor** : Installez le sensor de discovery `sensor.awtrix_topics_list`.
3.  **Moteur** : Déployez le script moteur `script.awtrix_moteur_v2_0_0`.
